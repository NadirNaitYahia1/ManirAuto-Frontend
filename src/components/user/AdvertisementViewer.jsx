...
import {context} from '../../pages/Pageuser'
...
return (
   <div className='cars   mx-auto mt-5 md:ms-4   basis-4/5'>
         <div className='grid md:grid-cols-3 sm:grid-cols-1 gap-3 '>
        {
            ...
            return (
                <div className='shadow-[0px_2px_3px_0px_#7A63F0] pb-4 rounded-[15px] border border-solid border-gray-300 border-opacity-80' key={index}>
